...
class LitleResponseProcessorFunctionalTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_badResponse()
    {
        ...
        new LitleResponseProcessor ($this->direct . '/pizza.tmp');
    }
    ...
    public function test_echeckPreNote_all()
    {
        ...
        $echeckPreNoteSaleHashAccErr = array(
            'orderId' => '301',
            'orderSource' => 'ecommerce',
            'billToAddress' => $billToAddress,
            'echeck' => $echeckAccErr
        ...
        $echeckPreNoteCreditHashSuccess = array(
            'orderId' => '000',
            'orderSource' => 'ecommerce',
            'billToAddress' => $billToAddress,
            'echeck' => $echeckSuccess
        ...
        $echeckPreNoteCreditHashRoutErr = array(
            'orderId' => '900',
            'orderSource' => 'ecommerce',
            'billToAddress' => $billToAddress,
            'echeck' => $echeckRoutErr
        ...
        $echeckPreNoteCreditHashAccErr = array(
            'orderId' => '301',
            'orderSource' => 'ecommerce',
            'billToAddress' => $billToAddress,
            'echeck' => $echeckAccErr
