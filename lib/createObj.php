...
class createObj{
	...
	$ob->$authorizationField[0]->$billToAddressField[0]->$billToAddressField[7]=$config["addressLine2"];
	$ob->$authorizationField[0]->$billToAddressField[0]->$billToAddressField[8]=$config["addressLine3"];
