...
class LitleRequestFunctionalTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_addBatch()
    {
        ...
        $expected = '<batchRequest merchantId="0180" merchantSdk="PHP;8.24.0" authAmount="0" numAuths="0" saleAmount="123" numSales="1" creditAmount="0" numCredits="0" numTokenRegistrations="0"
